...
namespace :homebrew do
  ...
  task :checkout do
    `git clone git@github.com:IntrepidPursuits/homebrew-formulae.git #{HOMEBREW_FORMULAE_DIR}`
  end
...
namespace :tarball do
  ...
  task :checkout do
    `git clone --branch gh-pages git@github.com:IntrepidPursuits/liftoff.git #{GH_PAGES_DIR}`
  end
